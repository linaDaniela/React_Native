...
const CrearMedicoModal = ({ visible, onClose, onMedicoCreated }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        Alert.alert('Error', response.message || 'Error al crear médico');
      }
    } catch (error) {
      ...
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>Crear Médico</Text>
