...
const CrearAdministradorModal = ({ visible, onClose, onSuccess }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      setLoading(true);
      const response = await administradoresService.create(formData);
      ...
      if (response.success) {
        ...
        Alert.alert('Error', response.message || 'Error al crear administrador');
      }
    } catch (error) {
