...
const CrearConsultorioModal = ({ visible, onClose, onConsultorioCreated }) => {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      const response = await consultoriosService.create(formData);
      if (response.success) {
        Alert.alert('Éxito', 'Consultorio creado exitosamente');
        setFormData({
          nombre: '',
          ubicacion: '',
          telefono: '',
        ...
        onConsultorioCreated();
        onClose();
      } else {
        Alert.alert('Error', response.message || 'Error al crear consultorio');
      }
    } catch (error) {
      console.error('Error al crear consultorio:', error);
      Alert.alert('Error', 'Error al crear consultorio');
    } finally {
      setLoading(false);
    }
  };
      ...
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>Crear Consultorio</Text>
